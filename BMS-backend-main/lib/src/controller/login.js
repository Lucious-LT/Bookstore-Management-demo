...
function handleUserLogin(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const checkIfEmailExist = yield auth_1.usersModel.findOne({ email });
            if (!checkIfEmailExist) {
                ...
                const token = jsonwebtoken_1.default.sign({ authorId: checkIfEmailExist.id }, 'your-secret-key', { expiresIn: '1h' });
