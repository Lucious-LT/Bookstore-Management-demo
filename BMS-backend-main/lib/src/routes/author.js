...
router.get('/:id', jwtAuthenticate_1.authenticate, bookController_1.getBooksBySingleAuthor);
// // creating a new books
router.post("/", jwtAuthenticate_1.authenticate, bookController_1.createNewBook);
// // updating a book
router.put('/', jwtAuthenticate_1.authenticate, bookController_1.updateBook);
// // deleting a book
